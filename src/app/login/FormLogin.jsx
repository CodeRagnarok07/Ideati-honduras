...
export default function FormLogin({ setUser}) {
    ...
    return (
        ...
        <form ref={formRef} onClick={e=>handleSubmit(e)} action="" className="w-full">
            ...
            <div class="flex justify-center md:mt-6">
                {/* <input type="submit" value={"Login"} class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"/> */}
                    <Link href="/dashboard" 
